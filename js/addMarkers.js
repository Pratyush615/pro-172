AFRAME.registerComponent("createmarkers", {
 ...
 //call the getAllToys function
    ...
    toys.map(toy => {
      ...
      var quantity = document.createElement("a-entity");
      quantity.setAttribute("id", `current_orders-${toy.id}`);
      console.log(`current_orders-${toy.id}`);

      var quantityValue = toy.current_orders.quantity;
      console.log(quantityValue)
      quantity.setAttribute("text", {
        font: "aileronsemibold",
        color: "#290149",
        width: 2,
        height: 5,
      ...
      mainPlane.appendChild(quantity);
